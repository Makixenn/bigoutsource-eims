...
- **`EmployeeProfile.tsx`**: Changed the label in the Work & Account Info section from "Department/Account Type" to **"DEPARTMENT/CAMPAIGN."**.
...
- **Where to look**: Scroll down to the **Work & Account Info** section to see "DEPARTMENT/CAMPAIGN." and the **Device Assets** section to see "REMOTE ID" (BIOS Date and Windows License Key will no longer appear here).
